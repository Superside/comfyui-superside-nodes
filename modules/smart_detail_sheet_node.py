...
class SupersideSmartDetailSheetNode(
    ...
    def _detect_details(self, client, model, image_url, num_details, detail_hint):
        ...
        prompt = (
            ...
            "the bridge), the temple arms (the full pieces extending back to the "
            "ears, not just their tips), the points where the lens itself mounts "
            "directly to the metal frame via small screws (common on rimless/"
            "drill-mount designs), and any other screws/rivets/logos; on footwear, "
            "prioritize stitching, sole texture, laces, and logos; on bags, "
            "prioritize hardware, zippers, and seams; on apparel, prioritize "
            "fabric weave, seams, buttons, and zippers. More generally, look for "
            "textures, materials, logos, joints, pads, seams, stitching, or other "
            f"unique design elements.{hint_line}\n\n"
