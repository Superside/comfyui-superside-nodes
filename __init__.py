...
NODE_DISPLAY_NAME_MAPPINGS = {
    "AnyLLMTextNode": "Any LLM Text",
    "AnyLLMVisionNode": "Any LLM Vision",
    "BriaBackgroundStandardizerNode": "Bria Background Standardizer (Hex Color)",
    "BriaReplaceBackgroundNode": "Bria Replace Background",
    "Florence2CaptionNode": "Florence-2 Detailed Caption",
    "Florence2RegionSelectorNode": "Florence-2 Smart Region Selector",
    "FluxKontextMaxMultiImageNode": "Flux Kontext Max Multi-Image Node",
    "GPTImage2EditNode": "GPT Image 2 Edit",
    "GrokImagineImageQualityEditNode": "Grok Imagine Image Quality Edit",
    "IdeogramUpscaleNode": "Ideogram Upscale",
    "JuggernautFluxProImg2ImgNode": "Juggernaut Flux Pro Image-to-Image",
    "Kling21ImageToVideoNode": "Kling 2.1 Image-to-Video",
    "Kling25TurboProImageToVideoNode": "Kling 2.5 Turbo Pro Image-to-Video",
    "NanoBananaProEditNode": "Nano Banana Pro Edit Node",
    "NanoBananaV2EditNode": "Nano Banana V2 Edit Node",
    "PASDUpscalerNode": "PASD Upscaler Node",
    "PromptBoxNode": "Prompt Box",
    "PromptSplitterNode": "Prompt Splitter",
    "SAM3RegionSelectorNode": "SAM 3 Smart Region Selector",
    "SeedanceLiteImageToVideoNode": "Seedance Lite Image-to-Video",
    "SeedanceProImageToVideoNode": "Seedance Pro Image-to-Video",
    "SeedreamV45EditNode": "Seedream V4.5 Edit",
    "SeedreamV5ProEditNode": "Seedream V5 Pro Edit",
    "SeedVR2UpscaleImageNode": "SeedVR2 Upscale Image",
    "SeedVRUpscaleVideoNode": "SeedVR Upscale Video",
    "TopazUpscaleImageNode": "Topaz Upscale Image",
    "Wan25ImageToImageNode": "Wan 2.5 Image-to-Image",
    "Wan25ImageToVideoNode": "Wan 2.5 Image-to-Video",
}
