...
1. Copy (or `git clone`) this folder into your ComfyUI `custom_nodes` directory:
   ```
   ComfyUI/custom_nodes/comfyui-superside-nodes/
   ```
...
#### Seedream V5 Pro Edit (`SeedreamV5ProEditNode`)
...
#### Seedream V4.5 Edit (`SeedreamV45EditNode`)
...
#### Nano Banana Pro Edit (`NanoBananaProEditNode`)
...
#### Nano Banana V2 Edit (`NanoBananaV2EditNode`)
...
#### GPT Image 2 Edit (`GPTImage2EditNode`)
...
#### Grok Imagine Image Quality Edit (`GrokImagineImageQualityEditNode`)
...
#### Flux Kontext Max Multi-Image Node (`FluxKontextMaxMultiImageNode`)
...
#### Juggernaut Flux Pro Image-to-Image (`JuggernautFluxProImg2ImgNode`)
...
#### Wan 2.5 Image-to-Image (`Wan25ImageToImageNode`)
...
#### Bria Background Standardizer - Hex Color (`BriaBackgroundStandardizerNode`)
...
#### Bria Replace Background (`BriaReplaceBackgroundNode`)
...
#### Kling 2.1 Image-to-Video (`Kling21ImageToVideoNode`)
...
#### Kling 2.5 Turbo Pro Image-to-Video (`Kling25TurboProImageToVideoNode`)
...
#### Seedance Lite Image-to-Video (`SeedanceLiteImageToVideoNode`)
...
#### Seedance Pro Image-to-Video (`SeedanceProImageToVideoNode`)
...
#### Wan 2.5 Image-to-Video (`Wan25ImageToVideoNode`)
...
#### Ideogram Upscale (`IdeogramUpscaleNode`)
...
#### PASD Upscaler Node (`PASDUpscalerNode`)
...
#### SeedVR2 Upscale Image (`SeedVR2UpscaleImageNode`)
...
#### SeedVR Upscale Video (`SeedVRUpscaleVideoNode`)
...
#### Topaz Upscale Image (`TopazUpscaleImageNode`)
...
#### Any LLM Vision (`AnyLLMVisionNode`)
...
#### Florence-2 Detailed Caption (`Florence2CaptionNode`)
...
#### Florence-2 Smart Region Selector (`Florence2RegionSelectorNode`)
...
#### SAM 3 Smart Region Selector (`SAM3RegionSelectorNode`)
...
#### Prompt Splitter (`PromptSplitterNode`)
